...
public class GridAdapter extends BaseAdapter {
    ...
    //생성할때 필요한 것 ▼
    public GridAdapter(ArrayList<KaKaoDTO> list, LayoutInflater inflater) {
        this.list = list;
    ...
    public View getView(int i, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {//한 칸을 말함 ▼
            ...
            viewHolder.imgv = convertView.findViewById(R.id.grid_img);
            viewHolder.tv1 = convertView.findViewById(R.id.grid_tv);
            viewHolder.tv2 = convertView.findViewById(R.id.grid_tv2);
            viewHolder.tv3 = convertView.findViewById(R.id.grid_tv3);
