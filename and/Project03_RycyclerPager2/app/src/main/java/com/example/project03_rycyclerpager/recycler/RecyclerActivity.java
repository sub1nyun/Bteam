...
RecyclerView rcv_act;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(RecyclerActivity.this, RecyclerView.VERTICAL, true);
        rcv_act.setLayoutManager(manager);
        getSupportFragmentManager().beginTransaction().replace(R.id.container, new Fragment1(list)).commit();
    }
}